...
@SpringBootTest(
        ...
        properties = {
                "sbapsd.servers.v1-s1.type=web-v1",
                "sbapsd.servers.v1-s1.params.url=http://localhost:${sba.server.port}",
                "sbapsd.servers.v1-s1.labels.__test=no-filters",
                "sbapsd.servers.v1-s2.type=web-v1",
                "sbapsd.servers.v1-s2.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v1-s3.type=web-v1",
                "sbapsd.servers.v1-s3.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v1-s4.type=web-v1",
                "sbapsd.servers.v1-s4.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v2-s1.type=web-v2",
                "sbapsd.servers.v2-s1.params.url=http://localhost:${sba.server.port}",
                "sbapsd.servers.v2-s1.labels.__test=no-filters",
                "sbapsd.servers.v2-s2.type=web-v2",
                "sbapsd.servers.v2-s2.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v2-s3.type=web-v2",
                "sbapsd.servers.v2-s3.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v2-s4.type=web-v2",
                "sbapsd.servers.v2-s4.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v3-s1.type=web-v2",
                "sbapsd.servers.v3-s1.params.url=http://localhost:${sba.server.port}",
                "sbapsd.servers.v3-s1.labels.__test=no-filters",
                "sbapsd.servers.v3-s2.type=web-v2",
                "sbapsd.servers.v3-s2.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v3-s3.type=web-v2",
                "sbapsd.servers.v3-s3.params.url=http://localhost:${sba.server.port}",
                ...
                "sbapsd.servers.v3-s4.type=web-v2",
                "sbapsd.servers.v3-s4.params.url=http://localhost:${sba.server.port}",
